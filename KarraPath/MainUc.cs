...
{
    [Serializable]
    public sealed partial class MainUc : UserControl
    {
        #region MyRegion

        private WorldPathfinder WPath { get; set; }

        private int MapId { get; set; }
        private int StartCell { get; set; }
        private int EndCell { get; set; }
        private bool UseDiag { get; set; }
        ...
        public bool FindPath(int start, int end, bool diag)
        {
            StartCell = start;
            EndCell = end;
            UseDiag = diag;
            return WPath.GetPath(StartCell, EndCell, UseDiag);
        }
    ...
    public class MapCell
    {
        ...
        public virtual void DrawBackground(MainUc parent, Graphics g, DrawMode mode)
        {
        ...
        public virtual void DrawForeground(MainUc parent, Graphics g, DrawMode mode)
        {
        ...
        public virtual Brush GetDefaultBrush(MainUc parent)
        {
